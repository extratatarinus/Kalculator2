...
public enum Rim {
    NULLA(0),I(1), II(2), III(3), IV(4), V(5), VI(6), VII(7), VIII(8), IX(9), X(10),
    ...
    public static Rim valueOf(int value) {
        for (Rim rim : Rim.values()) {
            if (rim.getValue() == value) {
                return rim;
            }
        }
        throw new IllegalArgumentException("Неправильное значение: " + value);
    }
}
